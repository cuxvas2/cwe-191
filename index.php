...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (is_numeric($_POST['cantidad'])) { //Validad que sea un número
...
<head>
    ...
    <title>Mercado Libre - Programacion segura</title>
...
<body>
    ...
    <div class="container mt-3">
        ...
        <h2>Tienda en linea <small class="text-muted fs-5">Programacion segura</small></h2>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li>Dispositivo desbloqueado para que elijas la compañía telefonica que prefieras.</li>
                                <li>Compatible con redes 5G.</li>
                                <li>Pantalla Dynamic AMOLED 2X de 6.7".</li>
                                <li>Tiene 3 camaras traseras de 50Mpx/12Mpx/10Mpx.</li>
